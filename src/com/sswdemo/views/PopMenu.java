...
import com.sswdemo.activitys.ServeActivity;
import com.sswdemo.adapters.PopAdapter;
...
public class PopMenu {
	...
	public void addData(int[] image,String[] name) {
		...
		for (int i = 0; i < image.length; i++) {
			...
			item.put("imgId",image[i]);
			item.put("name",name[i]);
			listData.add(item);
		}
		listView.setAdapter(new PopAdapter(context,listData));
	}
