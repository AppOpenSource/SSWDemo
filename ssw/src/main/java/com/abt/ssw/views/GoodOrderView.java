...
public class GoodOrderView extends LinearLayout {
	...
	public void setStayView(View title, View stayview, ScrollView scrollview,
	...
	public GoodOrderView(Context context) {
		super(context);
		mContext = context;
	}

	public GoodOrderView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		init();
	}
